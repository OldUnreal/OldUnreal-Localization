...
### Language-specific
* **_German:_** **Smirftsch, Jan "eGo" Urbansky, ividyon** and **Sly.** (review and contributions), **hosterholz** (additional contributions and further reviews)
...
* **_Czech:_** **tomcat** (Unreal localization), **Victor Delacroix and Nicola** (additional contributions and further reviews)
* **_Swedish:_** **ElectricIce** (additional contributions and further reviews)
* **_Catalan:_** **rarsonic** (additional contributions and further reviews)
* **_Dutch:_** **Rubie** (Unreal and UT review), **bennytrt and Hyper** (additional contributions and further reviews)
* **_Norwegian:_** **Excalidar** (additional contributions and further reviews)
* **_Japanese:_** **Vapor Mermaid** (localization retriever)
* **_Greek:_** **LDinos** (UT localization author)
